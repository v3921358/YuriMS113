        ...
        switch (type) {
            case EXP:
                ...
                if (c.isBeginnerJob()) {
                    ...
                    c.gainExp(MapleDataTool.getInt(data) * Server.getQExpRate() , true, true);
                }
                break;
            case ITEM:
            ...
            case MESO:
                ...
                int meso = MapleDataTool.getInt(data);
                meso = meso < 0 ? meso : meso * Server.getQMesoRate();
                c.gainMeso(meso , true, false, true);
                break;
            case QUEST:
            ...
            case PETSKILL:
                ...
                c.getPet(0).setFlags((byte) ItemConstants.getFlagByInt(flag));
                break;
            default:
        }
    }
