...
import net.server.login.handlers.CharSelectedHandler;
import net.server.login.handlers.CheckCharNameHandler;
import net.server.login.handlers.ServerlistRequestHandler;
import net.server.login.handlers.CharlistRequestHandler;
import net.server.login.handlers.SetGenderHandler;
import net.server.login.handlers.LoginPasswordHandler;
import net.server.login.handlers.CreateCharHandler;
import net.server.login.handlers.ServerStatusRequestHandler;
import net.server.login.handlers.DeleteCharHandler;
...
public final class PacketProcessor {
    ...
    public void reset(int channel) {
        ...
        registerHandler(RecvOpcode.CLIENT_START_ERROR, new ClientErrorHandler());
        ...
        if (channel < 0) {//login
            ...
            registerHandler(RecvOpcode.ITEM_GATHER, new ItemGatherHandler());
            ...
            registerHandler(RecvOpcode.UPDATE_CHAR_PROFILE, new UpdateCharProfileHandler());
