...
//                    slea.readMapleAsciiString();//guild name
            ...
            case 0x08:
                ...
                Server.getInstance().allianceMessage(alliance.getId(), AlliancePacket.changeAllianceRankTitle(alliance.getId(), ranks), -1, -1);
                break;
            case 0x09: {
            ...
            case 0x0A:
                ...
                Server.getInstance().allianceMessage(alliance.getId(), AlliancePacket.allianceNotice(alliance.getId(), notice), -1, -1);
                break;
            default:
