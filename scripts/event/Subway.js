...
function scheduleNew() {
    ...
    if(toggleMsg) {
        KC_docked.broadcastMessage(MaplePacketCreator.serverNotice(0, "地鐵列車已經來了."));
        NLC_docked.broadcastMessage(MaplePacketCreator.serverNotice(0, "地鐵列車已經來了."));
    }
...
function takeoff() {
    ...
    if(toggleMsg) {
        KC_docked.broadcastMessage(MaplePacketCreator.serverNotice(0, "地鐵列車已經離開了."));
        NLC_docked.broadcastMessage(MaplePacketCreator.serverNotice(0, "地鐵列車已經離開了."));
    }
