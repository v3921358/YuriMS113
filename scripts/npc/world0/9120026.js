...
function action(mode, type, selection) {
	...
	switch (selection) {
	    case 0:
		questid = cm.isQuestStarted(4682) == 2;
		mapid = 802000200;
		portal = 2;
		break;
	    case 1:
		questid = cm.isQuestStarted(4687) == 2;
		mapid = 802000300;
		portal = 0;
		break;
	    case 2:
		questid = cm.isQuestStarted(4690) == 2;
		mapid = 802000500;
		portal = 0;
		break;
	    case 3:
		questid = cm.isQuestStarted(4694) == 2;
		mapid = 802000600;
		portal = 0;
		break;
	    case 4:
		questid = cm.isQuestStarted(50001) == 2;
		mapid = 802000700;
		portal = 0;
		break;
	    case 5:
		questid = cm.isQuestStarted(50015) == 2;
		mapid = 802000800;
		portal = 0;
		break;
	    case 7:
		questid = cm.isQuestStarted(50017) == 2;
		mapid = 802000820;
		portal = 0;
		break;
	}
