...
function start() {
    cm.sendNext("嗨， 我叫#b珀爾#k，如果你不忙的話... 我可以佔用你一點時間嗎？ I heard there are people gathering up around here for an #revent#k but I don't want to go there by myself ... Well, do you want to go check it out with me?");
}
